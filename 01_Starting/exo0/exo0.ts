...
export const isOddF: (value: number) => boolean = (value: number) =>
  flow(isEven, not)(value);
...
export const next3: (value: number) => number = (value: number) =>
  flow(next, next, next)(value);
